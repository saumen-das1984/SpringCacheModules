...
import com.signify.cacheresolver.config.BookQueryConfig;
import com.signify.cacheresolver.mapper.BookMapper;
...
public class BookServiceImp implements BookService {
	...
	@Override
	@Cacheable(cacheNames = "books_id", cacheResolver = "cacheResolver")
	...
	@SuppressWarnings("deprecation")
	@Override
	@Cacheable(cacheNames ="books_title", cacheResolver = "cacheResolver")
	...
	@Override
	@Cacheable(cacheNames = "books", cacheResolver = "cacheResolver")
